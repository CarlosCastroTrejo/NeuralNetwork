...
int numberOfPartitions=2; // Number of divisions in the canvas
...
void draw() {
  ...
  */
  ...
  // Does not use the "known" correct answer
   ...
   ellipse(training[i].inputs[0], training[i].inputs[1], 10, 10);
   }
